...
<head>
    ...
    <link rel="preload" href="{{ asset ('vrtour/script.js?v=1675052430229') }}" as="script"/>
    <link href="/img/logo-unimal.png" rel="icon">
    <link href="/img/logo-unimal.png" rel="icon">
    <link rel="preload" href="{{ asset ('vrtour/media/panorama_FBD5C461_F506_5EEA_41B6_92DB412F8EFE_0/l/2/0_0.jpg?v=1675052430229') }}" as="image"/>
    <link rel="preload" href="{{ asset ('vrtour/media/panorama_FBD5C461_F506_5EEA_41B6_92DB412F8EFE_0/r/2/0_0.jpg?v=1675052430229') }}" as="image"/>
    <link rel="preload" href="{{ asset ('vrtour/media/panorama_FBD5C461_F506_5EEA_41B6_92DB412F8EFE_0/u/2/0_0.jpg?v=1675052430229') }}" as="image"/>
    <link rel="preload" href="{{ asset ('vrtour/media/panorama_FBD5C461_F506_5EEA_41B6_92DB412F8EFE_0/d/2/0_0.jpg?v=1675052430229') }}" as="image"/>
    <link rel="preload" href="{{ asset ('vrtour/media/panorama_FBD5C461_F506_5EEA_41B6_92DB412F8EFE_0/f/2/0_0.jpg?v=1675052430229') }}" as="image"/>
    <link rel="preload" href="{{ asset ('vrtour/media/panorama_FBD5C461_F506_5EEA_41B6_92DB412F8EFE_0/b/2/0_0.jpg?v=1675052430229') }}" as="image"/>
    ...
    <script src="{{ asset ('vrtour/lib/tdvplayer.js?v=1675052430229') }}"></script>
    <script type="text/javascript">
        ...
        function loadTour()
        {
            ...
            settings.set(TDV.PlayerSettings.SCRIPT_URL, 'vrtour/script.js?v=1675052430229');
            settings.set(TDV.PlayerSettings.WEBVR_POLYFILL_URL, 'vrtour/lib/WebVRPolyfill.js?v=1675052430229');
            settings.set(TDV.PlayerSettings.HLS_URL, 'vrtour/lib/Hls.js?v=1675052430229');
            settings.set(TDV.PlayerSettings.QUERY_STRING_PARAMETERS, 'v=1675052430229');
...
loadTour()
    ...
    <link rel="stylesheet" href="{{ asset ('vrtour/fonts.css?v=1675052430229') }}">
</head>
<body onload="onLoad()">
